...
import localeFormat=require("dojo/date/locale");
import Draw = require("esri/toolbars/draw");
import domReady=require("dojo/domReady");
import WidgetSet=require("dijit/WidgetSet");
import Extent=require("esri/geometry/Extent");
//import _Widget=require("dijit/_Widget");
import Search=require("esri/dijit/Search");
import Draw_Point=require("../widgets/Draws/Draw_Point/Draw_Point");
...
var selectedSymbol = new SimpleFillSymbol(
    ...
    new SimpleLineSymbol(SimpleLineSymbol.STYLE_DASH, new Color("#CA0013"), 2),
...
//定义当前是否在获取GPS
var geolocation_state: number = 0;
//定义连续获取坐标
var watchId;
...
var layerList: LayerList = new LayerList({
    map: map,
    showLegend: true,
    showSubLayers: true,
...
function gpsLocate() {
    if (geolocation_state == 0) {
        ...
        locate();
        watchId = navigator.geolocation.watchPosition(locate,
            onLocateError,
            {
                timeout: 50000,
