...
import TDT=require("../tdt/TDT_ZJ");
import TDT_China=require("../tdt/tdtlayer");
...
import esriLang=require("esri/lang");
...
function onQueryTask_XZQHError(evt: object) {
...
function onLayersAddResult(evt: object) {
