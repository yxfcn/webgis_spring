...
//属性识别部件
var attInspector: AttributeInspector = new AttributeInspector({
...
function onMapClick(evt: object) {
...
function onLayersAddResult(evt) {
    ...
    attInspector.on("attribute-change", function (evt: object) {
...
function OnExtentChange(evt: object) {
...
function onLayerAdd(evt: object) {
